    ...
    try:
        ...
        if (args.recorder_time > 0):
            ...
            while True:
                ...
                if tt >2.0 and tt < 10.00:
                  actor_list[0].apply_control(carla.VehicleControl(throttle=0.506, brake=0, steer=0))
                elif tt >10.0 and tt < 20.00:
                  actor_list[0].apply_control(carla.VehicleControl(throttle=0.41, brake=0, steer=0))
                elif tt >= 20.0 and tt < 50.55:
                  actor_list[0].disable_constant_velocity()
                  actor_list[0].apply_control(carla.VehicleControl(throttle=0, brake=0.35, steer=0))
